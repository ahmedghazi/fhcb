...
// Scope chain inside filters[]: ^ = module doc.
// Inside a nested *[] the chain adds one level per *[], so ^^^ = module doc
// when writing *[artist && _id in *[exhibition && ^^^.filterTags...]].
...
const filterList = `
  _type == "filterList" => {
    ...,
    "filterOptions": select(
      filterKey == "artist" => select(
        ^._type == "listProductUI" => *[_type == "artist" && _id in *[_type == "product"].artists[]._ref] | order(name asc) { _id, _type, name, last_name, slug },
        ^._type == "listFeuilletageUI" => *[_type == "artist" && _id in *[_type == "feuilletage"].artists[]._ref] | order(name asc) { _id, _type, name, last_name, slug },
        ^._type == "listImageImages" => *[_type == "artist" && _id in *[_type == "imageImages"].artists[]._ref] | order(name asc) { _id, _type, name, last_name, slug },
        ^._type == "listSerieThematiqueUI" => *[_type == "artist" && _id in *[_type == "serieThematique"].artists[]._ref] | order(name asc) { _id, _type, name, last_name, slug },
        ^._type == "listConversationUI" => *[_type == "artist" && _id in *[_type == "conversation"].artists[]._ref] | order(name asc) { _id, _type, name, last_name, slug },
        ^._type == "listExhibitionsPastUI" => *[_type == "artist" && _id in *[${exhibitionFilter}].artists[]._ref] | order(name asc) { _id, _type, name, last_name, slug },
        ^._type == "listExhibitionsEventsUI" => *[_type == "artist" && _id in (*[${exhibitionFilter}].artists[]._ref + *[${eventFilter}].artists[]._ref)] | order(name asc) { _id, _type, name, last_name, slug },
        *[_type == "artist"] | order(name asc) { _id, _type, name, last_name, slug }
      ),
      filterKey == "tag" => select(
        ^._type == "listFeuilletageUI" => *[_type == "tag" && _id in *[_type == "feuilletage"].tags[]._ref] | order(coalesce(title.fr, title.en) asc) { _id, _type, title, slug },
        ^._type == "listExhibitionsPastUI" => *[_type == "tag" && _id in *[${exhibitionFilter}].tags[]._ref] | order(coalesce(title.fr, title.en) asc) { _id, _type, title, slug },
        ^._type == "listExhibitionsEventsUI" => *[_type == "tag" && _id in (*[${exhibitionFilter}].tags[]._ref + *[${eventFilter}].tags[]._ref)] | order(coalesce(title.fr, title.en) asc) { _id, _type, title, slug },
        *[_type == "tag"] | order(coalesce(title.fr, title.en) asc) { _id, _type, title, slug }
      ),
      filterKey == "tagProduct" => *[_type == "tagProduct" && _id in *[_type == "product"].categories[]._ref] | order(coalesce(title.fr, title.en) asc) { _id, _type, title, slug },
      filterKey == "chercheur" => select(
        ^._type == "listFeuilletageUI" => *[_type == "chercheur" && _id in *[_type == "feuilletage"].chercheur._ref] | order(name asc) { _id, _type, name, last_name, slug },
        ^._type == "listImageImages" => *[_type == "chercheur" && _id in *[_type == "imageImages"].chercheur._ref] | order(name asc) { _id, _type, name, last_name, slug },
        ^._type == "listSerieThematiqueUI" => *[_type == "chercheur" && _id in *[_type == "serieThematique"].chercheur._ref] | order(name asc) { _id, _type, name, last_name, slug },
        ^._type == "listConversationUI" => *[_type == "chercheur" && _id in *[_type == "conversation"].chercheur._ref] | order(name asc) { _id, _type, name, last_name, slug },
        *[_type == "chercheur"] | order(name asc) { _id, _type, name, last_name, slug }
      ),
